...
describe('Toolbar', () => {
  it('renders all four menu labels', () => {
    render(<Toolbar viewMode="raw" onViewModeChange={() => {}} text="" onTextChange={() => {}} />)
  ...
  it('gives Formatted Document button variant="secondary" when viewMode is "visualizer"', () => {
    render(<Toolbar viewMode="visualizer" onViewModeChange={() => {}} text="" onTextChange={() => {}} />)
    const editBtn = screen.getByLabelText('Edit')
  ...
  it('clicking Edit button calls onViewModeChange with "raw"', () => {
    ...
    render(<Toolbar viewMode="visualizer" onViewModeChange={handler} text="" onTextChange={() => {}} />)
  ...
  it('clicking Formatted Document button calls onViewModeChange with "visualizer"', () => {
    const handler = jest.fn()
    render(<Toolbar viewMode="raw" onViewModeChange={handler} text="" onTextChange={() => {}} />)
